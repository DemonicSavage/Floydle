var app = (function () {
      ...
      m.$on("click", e[4]),
      {
        c() {
          (t = w("header")),
            ...
            (l = x()),
            (u = w("h1")),
            (u.textContent = "Pink Floyd Heardle"),
            (c = x()),
            (d = w("div")),
            Q(h.$$.fragment),
            (f = x()),
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for Pink Floyd songs. Each song is randomly chosen from their studio album discography.</p> \n\n<p class="mb-3">Made by <a href="https://reddit.com/user/DemonicSavage">/u/DemonicSavage</a>. All copyright goes to Pink Floyd.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/floydle">here</a>.'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Pink Floyd song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Pink Floyd Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Pink Floyd Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _(
          "You didn't get today's Pink Floyd Heardle. Better luck tomorrow!"
        );
      },
      m(e, t) {
        g(e, n, t);
    ...
    return (
      ...
      [
        ...
        () => {
          ...
          let e = "Pink Floyd Heardle #" + (s.id + 1),
            t = "";
          a
          ...
          for (let e = 0; e < i.maxAttempts; e++)
            r.length > e
              ...
              : (t += "⬜️");
          let o =
            e + "\n\n" + t + "\n\n" + "https://Pink Floyd-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
      ...
      "Pink Floyd - The Grand Vizer's Garden Party (Parts 1-3)",
      "Pink Floyd - Seamus",
    ...
    On = {
      subscribe: ue(
        [
          {
            url: "https://soundcloud.com/officialpinkfloyd/the-final-cut-2011-remastered",
            answer: "Pink Floyd - The Final Cut",
          },
          {
            url: "https://soundcloud.com/officialpinkfloyd/coming-back-to-life-2011",
            answer: "Pink Floyd - Coming Back To Life",
          },
          {
            url: "https://soundcloud.com/officialpinkfloyd/a-new-machine-part-1-2011",
            answer: "Pink Floyd - A New Machine Part 1",
          },
          {
            url: "https://soundcloud.com/officialpinkfloyd/side-3-pt-4-allons-y-1-1",
            answer: "Pink Floyd - Allons-y (1)",
          },
          {
            url: "https://soundcloud.com/officialpinkfloyd/one-of-the-few-2011-remastered",
            answer: "Pink Floyd - One of The Few",
          },
          {
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Pink Floyd Heardle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the Pink Floyd song from the intro in as few tries as possible"
          ),
